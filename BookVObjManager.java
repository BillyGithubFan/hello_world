    ...
    public BookVObj loadBookVObj(int id)
    {
        ...
        try
        {
            ...
            if (found)
            {
                ...
                // per this demonstration, we will just set dummy values
                // to any id  passed in, and set dummy values to its 
                // attributes as well, and assume it is loaded fine from
                // the database
                vObj.bookId = id;
                vObj.title="my Tiltle";
                vObj.author="Billy";
                vObj.ISBN="3456KNM";
                SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd"); 
                vObj.publishDate=format.parse ( "2018-12-31" );
